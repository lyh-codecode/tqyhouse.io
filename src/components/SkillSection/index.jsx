    ...
    const skills = [
        {
            name: 'JavaScript',
            icon: jsIcon,
            description: '深入理解 ES6+，掌握异步编程、原型链、闭包等核心概念',
            color: '#f7df1e'
        },
        {
            name: 'Vue',
        ...
        },
        {
            name: '微信小程序',
            icon: wxIcon,
            description: '微信小程序开发，包括原生开发和框架开发，熟悉小程序生态',
            color: '#2ed15c'
        },
        {
            name: 'Taro',
            icon: taroIcon,
            description: '跨端开发框架，可同时开发多端小程序和 H5 应用',
            color: '#0969da'
        },
        {
            name: 'Node.js',
        ...
        },
        {
            name: 'TypeScript',
            icon: typeSIcon,
            description: '熟练使用 TypeScript 进行类型安全的开发，了解高级类型和泛型编程',
            color: '#3178c6'
        },
        {
            name: 'Webpack',
            icon: webpackIcon,
            description: '熟悉前端工程化，包括模块打包、代码分割、性能优化等',
            color: '#8dd6f9'
        },
        {
            name: 'Vite',
            icon: viteIcon,
            description: '前端工具，提供快速的开发环境和构建工具',
            color: '#646CFF'
        },
        {
            name: 'Git',
            icon: gitIcon,
            description: '熟练使用 Git 进行版本控制，了解分支管理、代码review等',
            color: '#f05032'
        }
    ]
